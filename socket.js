// var ws = new WebSocket("ws://127.0.0.1:6001");//test locally
var ws = new WebSocket("ws://172.26.5.78:6001");//In order to let others use
...
$('#start_push').on('click', function () {
    ...
    if (parseInt(localStorage.selector) == 1) {
        ...
        //TODO:Fix the bug of `navigator.getUserMedia is not a function` on latest browsers  
